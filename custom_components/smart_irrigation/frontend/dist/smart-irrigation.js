!function (e) {
  ...
  const q = (e, t) => {
    ...
    for (let t = 0; t < a; t++) {
      ...
      let o,
        ...
        u = -1,
        d = 0;
      for (; d < a.length && (r.lastIndex = d, l = r.exec(a), null !== l);) d = r.lastIndex, r === C ? "!--" === l[1] ? r = j : void 0 !== l[1] ? r = L : void 0 !== l[2] ? (U.test(l[2]) && (n = RegExp("</" + l[2], "g")), r = I) : void 0 !== l[3] && (r = I) : r === I ? ">" === l[0] ? (r = null != n ? n : C, u = -1) : void 0 === l[1] ? u = -2 : (u = r.lastIndex - l[2].length, o = l[1], r = void 0 === l[3] ? I : '"' === l[3] ? R : B) : r === R || r === B ? r = I : r === j || r === L ? r = C : (r = I, n = void 0);
      const c = r === I && e[t + 1].startsWith("/>") ? " " : "";
      s += r === C ? a + x : u >= 0 ? (i.push(o), a.slice(0, u) + A + a.slice(u) + T + c) : a + T + (-2 === u ? (i.push(void 0), t) : c);
    }
  ...
  class Q {
    ...
    _$AI(e, t = this) {
      e = X(this, e, t), H(e) ? e === V || null == e || "" === e ? (this._$AH !== V && this._$AR(), this._$AH = V) : e !== this._$AH && e !== F && this._(e) : void 0 !== e._$litType$ ? this.g(e) : void 0 !== e.nodeType ? this.$(e) : (e => P(e) || "function" == typeof (null == e ? void 0 : e[Symbol.iterator]))(e) ? this.T(e) : this._(e);
    }
    k(e) {
    ...
    _(e) {
      this._$AH !== V && H(this._$AH) ? this._$AA.nextSibling.data = e : this.$(z.createTextNode(e)), this._$AH = e;
    }
    g(e) {
      var t;
      const {
  ...
  var mt = {
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Tägliche Update-Zeit"
            },
            options: {
              days: "Tage",
              hours: "Stunden",
    ...
    $t = {
      pyeto: {
        description: "Calculate duration using the standardized FAO56 Penman-Monteith evapotranspiration method from the PyETO library. This method is globally applicable and recommended by the UN Food and Agriculture Organization for reference evapotranspiration calculations."
      },
      static: {
      ...
      knmi: {
        description: "Calculate duration optimized for the Netherlands using KNMI Makkink evapotranspiration data. Provides highly accurate, location-specific evapotranspiration calculations based on official Dutch meteorological data from the Royal Netherlands Meteorological Institute (KNMI)."
      }
    },
    Mt = {
      general: {
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Daily update time"
            },
            options: {
              days: "days",
              hours: "hours",
      ...
      modules: {
        cards: {
          ...
          module: {
            ...
            "config-descriptions": {
              KNMI: {
                coastal: "Enable if your location is on or adjacent to coast of a large land mass or where air masses are influenced by a nearby water body. Improves accuracy for coastal areas by adjusting wind speed and humidity calculations.",
                solrad_behavior: "Determines how to retrieve or estimate solar radiation data. Choose the method that best matches your available data sources and local conditions.",
                forecast_days: "Number of forecast days (0-5) to consider when deciding whether to irrigate. This helps avoid unnecessary watering when rain is predicted. Set to 0 to disable forecast-based irrigation adjustments."
              },
              PyETO: {
                coastal: "Enable if your location is on or adjacent to coast of a large land mass or where air masses are influenced by a nearby water body. Improves accuracy for coastal areas by adjusting wind speed and humidity calculations for FAO56 Penman-Monteith calculations.",
                solrad_behavior: "Determines how to retrieve or estimate solar radiation for FAO56 evapotranspiration calculations. Choose the method that best matches your available weather data sources.",
                forecast_days: "Number of forecast days (0-5) to consider when deciding whether to irrigate. This helps avoid unnecessary watering when rain is predicted. Set to 0 to disable forecast-based irrigation adjustments."
              }
            },
            "translated-options": {
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Hora de actualización diaria"
            },
            options: {
              days: "días",
              hours: "horas",
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Heure de mise à jour quotidienne"
            },
            options: {
              days: "jours",
              hours: "heures",
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Ora di aggiornamento giornaliero"
            },
            options: {
              days: "giorni",
              hours: "ore",
    ...
    ia = {
      pyeto: {
        description: "Bereken duur met de gestandaardiseerde FAO56 Penman-Monteith evapotranspiratie methode uit de PyETO library. Deze methode is wereldwijd toepasbaar en aanbevolen door de VN Voedsel- en Landbouworganisatie voor referentie evapotranspiratie berekeningen."
      },
      static: {
      ...
      knmi: {
        description: "Bereken duur geoptimaliseerd voor Nederland met KNMI Makkink evapotranspiratie gegevens. Biedt zeer nauwkeurige, locatie-specifieke evapotranspiratie berekeningen gebaseerd op officiële Nederlandse meteorologische gegevens van het Koninklijk Nederlands Meteorologisch Instituut (KNMI)."
      }
    },
    na = {
      general: {
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Dagelijkse update tijd"
            },
            options: {
              days: "dagen",
              hours: "uren",
        ...
        cards: {
          ...
          module: {
            ...
            "translated-options": {
              ...
              EstimateFromSunHoursAndTemperature: "Gebaseerd op gemiddelde van zon uren en temperatuur"
            }
          }
        },
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Daglig oppdateringstid"
            },
            options: {
              days: "dager",
              hours: "timer",
        ...
        cards: {
          ...
          "automatic-update": {
            ...
            labels: {
              ...
              "auto-update-first-time": "Čas dennej aktualizácie"
            },
            options: {
              days: "dni",
              hours: "hodiny",
  ...
  function Sa(e, t) {
    ...
    return (t && t.strategy ? t.strategy : Aa)(e, {
      cache: a,
      serializer: i
    });
  }
  ...
  function Ma(e, t, a, i, n) {
    return a.bind(t, e, i, n);
  }
  function Aa(e, t) {
    return Ma(e, this, 1 === e.length ? Ea : $a, t.cache.create(), t.serializer);
  }
  var Ta = function () {
  ...
  var xa,
    ...
    Pa = {
      variadic: function (e, t) {
        return Ma(e, this, $a, t.cache.create(), t.serializer);
      },
      monadic: function (e, t) {
        return Ma(e, this, Ea, t.cache.create(), t.serializer);
      }
    };
  function Na(e) {
  ...
  var ci = !!String.prototype.startsWith && "_a".startsWith("a", 1),
    ...
    bi = !0;
  try {
    bi = "a" === (null === (si = Mi("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a")) || void 0 === si ? void 0 : si[0]);
  } catch (j) {
    bi = !1;
  }
  var yi,
  ...
  if (bi) {
    var Ai = Mi("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    yi = function (e, t) {
      var a;
      return Ai.lastIndex = t, null !== (a = Ai.exec(e)[1]) && void 0 !== a ? a : "";
    };
  ...
  function Pi(e) {
    e.forEach(function (e) {
      if (delete e.location, Ba(e) || Ra(e)) for (var t in e.options) delete e.options[t].location, Pi(e.options[t].value);else ja(e) && Fa(e.style) || (La(e) || Ia(e)) && Va(e.style) ? delete e.style.location : Ya(e) && Pi(e.children);
    });
  }
  function Ni(e, t) {
    void 0 === t && (t = {}), t = i({
    ...
    for (var o = [], l = 0, u = e; l < u.length; l++) {
      ...
      if (Na(d)) o.push({
        ...
        if (Ca(d)) h && "string" != typeof h && "number" != typeof h || (h = "string" == typeof h || "number" == typeof h ? String(h) : ""), o.push({
          ...
          var p = "string" == typeof d.style ? i.date[d.style] : Va(d.style) ? d.style.parsedOptions : void 0;
          o.push({
            type: Ci.literal,
            value: a.getDateTimeFormat(t, p).format(h)
          });
        } else if (Ia(d)) {
          p = "string" == typeof d.style ? i.time[d.style] : Va(d.style) ? d.style.parsedOptions : i.time.medium;
          o.push({
            type: Ci.literal,
            value: a.getDateTimeFormat(t, p).format(h)
          });
        } else if (ja(d)) {
          (p = "string" == typeof d.style ? i.number[d.style] : Fa(d.style) ? d.style.parsedOptions : void 0) && p.scale && (h *= p.scale || 1), o.push({
            type: Ci.literal,
          ...
          if (Ya(d)) {
            var m = d.children,
              g = d.value,
              f = n[g];
            if (!Ri(f)) throw new Ii(g, "function", r);
  ...
  class Xi extends Ki {
    constructor(e) {
      if (super(e), this.et = V, e.type !== qi) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
    }
    render(e) {
...
`;
  ...
  let on = class extends pt(ue) {
    ...
    async _fetchData() {
      ...
      this.hass && (this.config = await ut(this.hass), this.data = (e = this.config, t = ["calctime", "autocalcenabled", "autoupdateenabled", "autoupdateschedule", "autoupdatefirsttime", "autoupdateinterval", "autoclearenabled", "cleardatatime", "continuousupdates", "sensor_debounce"], e ? Object.entries(e).filter(([e]) => t.includes(e)).reduce((e, [t, a]) => Object.assign(e, {
        [t]: a
      }), {}) : {}), console.log("Smart Irrigation Debug - this.data:", this.data), console.log("Smart Irrigation Debug - this.config:", this.config));
    }
    firstUpdated() {
      (async () => {
        await ye();
    ...
    render() {
      ...
      if (this.hass && this.config && this.data) {
        ...
        this.data.autocalcenabled && (t = Y`${t}
          <div class="card-content">
            <label for="calctime"
      ...
      >`;
        ...
        this.data.autoupdateenabled && (a = Y`${a}
          <div class="card-content">
          ...
          this.saveData({
            ...
            />          </div>          ${(null === (e = this.data) || void 0 === e ? void 0 : e.autoupdateschedule) === Se ? Y`
          <div class="card-content">
            <label for="updatefirsttime"
              >${Zi("panels.general.cards.automatic-update.labels.auto-update-first-time", this.hass.language)}:</label
            >
            <input
              id="updatefirsttime"
              type="time"
              ...
              @input=${e => {
          this.saveData({
            autoupdatefirsttime: e.target.value
          });
        }}
            />
          </div>` : ""}`), a = Y`<ha-card header="${Zi("panels.general.cards.automatic-update.header", this.hass.language)}">${a}</ha-card>`;
        ...
        this.data.autoclearenabled && (i = Y`${i}
          <div class="card-content">
            <label for="calctime"
          ...
          this.saveData({
            ...
            />
          </div>`), i = Y`<ha-card header="${Zi("panels.general.cards.automatic-clear.header", this.hass.language)}" >${i}</div></ha-card>`;
        let n = Y`<div class="card-content">
          <svg
            style="width:24px;height:24px"
            viewBox="0 0 24 24"
        ...
        this.data.continuousupdates && (n = Y`${n}
          <div class="card-content">
    ...
    saveData(e) {
      var t, a;
      this.hass && this.data && (this.data = Object.assign(Object.assign({}, this.data), e), (t = this.hass, a = this.data, t.callApi("POST", _e + "/config", a)).catch(e => {
        var t;
        return an(e, (null === (t = this.renderRoot) || void 0 === t ? void 0 : t.querySelector("ha-card")) || document.createElement("div"));
      }).then());
    }
    toggleInformation(e) {
      var t;
      const a = null === (t = this.renderRoot) || void 0 === t ? void 0 : t.querySelector("#" + e);
  ...
  var pn = (cn || (cn = 1, function (e) {
      e.exports = function () {
        ...
        var M,
          A = {};
        function T(e, t) {
          null != i.deprecationHandler && i.deprecationHandler(e, t), A[e] || (E(t), A[e] = !0);
        }
        function O(e) {
        ...
        function U(e) {
          var t,
            a,
            i = e.match(C);
          for (t = 0, a = i.length; t < a; t++) I[i[t]] ? i[t] = I[i[t]] : i[t] = R(i[t]);
          return function (t) {
            var n,
              s = "";
        ...
        function Y(e, t) {
          return e.isValid() ? (t = F(t, e.localeData()), L[t] = L[t] || U(t), L[t](e)) : e.localeData().invalidDate();
        }
        function F(e, t) {
          var a = 5;
          function i(e) {
        ...
        }), B(0, ["YYYY", 4], 0, "year"), B(0, ["YYYYY", 5], 0, "year"), B(0, ["YYYYYY", 6, !0], 0, "year"), Me("Y", ye), Me("YY", he, le), Me("YYYY", fe, de), Me("YYYYY", ve, ce), Me("YYYYYY", ve, ce), He(["YYYYY", "YYYYYY"], je), He("YYYY", function (e, t) {
        ...
        }), Me("M", he, Ee), Me("MM", he, le), Me("MMM", function (e, t) {
        ...
        B("w", ["ww", 2], "wo", "week"), B("W", ["WW", 2], "Wo", "isoWeek"), Me("w", he, Ee), Me("ww", he, le), Me("W", he, Ee), Me("WW", he, le), Pe(["w", "ww", "W", "WW"], function (e, t, a, i) {
          t[i.substr(0, 1)] = ze(e);
        });
        var $t = {
          dow: 0,
        ...
        }), Qt("a", !0), Qt("A", !1), Me("a", ea), Me("A", ea), Me("H", he, $e), Me("h", he, Ee), Me("k", he, Ee), Me("HH", he, le), Me("hh", he, le), Me("kk", he, le), Me("hmm", pe), Me("hmmss", me), Me("Hmm", pe), Me("Hmmss", me), He(["H", "HH"], Be), He(["k", "kk"], function (e, t, a) {
          var i = ze(e);
          t[Be] = 24 === i ? 0 : i;
        }), He(["a", "A"], function (e, t, a) {
          a._isPm = a._locale.isPM(e), a._meridiem = e;
        }), He(["h", "hh"], function (e, t, a) {
          t[Be] = ze(e), f(a).bigHour = !0;
        }), He("hmm", function (e, t, a) {
          var i = e.length - 2;
          t[Be] = ze(e.substr(0, i)), t[Re] = ze(e.substr(i)), f(a).bigHour = !0;
        }), He("hmmss", function (e, t, a) {
          var i = e.length - 4,
            n = e.length - 2;
          t[Be] = ze(e.substr(0, i)), t[Re] = ze(e.substr(i, 2)), t[Ue] = ze(e.substr(n)), f(a).bigHour = !0;
        }), He("Hmm", function (e, t, a) {
          var i = e.length - 2;
          t[Be] = ze(e.substr(0, i)), t[Re] = ze(e.substr(i));
        }), He("Hmmss", function (e, t, a) {
          var i = e.length - 4,
            n = e.length - 2;
          t[Be] = ze(e.substr(0, i)), t[Re] = ze(e.substr(i, 2)), t[Ue] = ze(e.substr(n));
        });
        var aa = /[ap]\.?m?\.?/i,
          ia = Ke("Hours", !0);
        function na(e, t, a) {
        ...
        function ya(e) {
          var t,
            a = e._a;
          return a && -2 === f(e).overflow && (t = a[Le] < 0 || a[Le] > 11 ? Le : a[Ie] < 1 || a[Ie] > at(a[je], a[Le]) ? Ie : a[Be] < 0 || a[Be] > 24 || 24 === a[Be] && (0 !== a[Re] || 0 !== a[Ue] || 0 !== a[Ye]) ? Be : a[Re] < 0 || a[Re] > 59 ? Re : a[Ue] < 0 || a[Ue] > 59 ? Ue : a[Ye] < 0 || a[Ye] > 999 ? Ye : -1, f(e)._overflowDayOfYear && (t < je || t > Ie) && (t = Ie), f(e)._overflowWeeks && -1 === t && (t = Fe), f(e)._overflowWeekday && -1 === t && (t = Ve), f(e).overflow = t), e;
        }
        ...
        function La(e) {
          var t,
            ...
            r = [];
          if (!e._d) {
            for (i = ja(e), e._w && null == e._a[Ie] && null == e._a[Le] && Ia(e), null != e._dayOfYear && (s = Ca(e._a[je], i[je]), (e._dayOfYear > Ge(s) || 0 === e._dayOfYear) && (f(e)._overflowDayOfYear = !0), a = yt(s, 0, e._dayOfYear), e._a[Le] = a.getUTCMonth(), e._a[Ie] = a.getUTCDate()), t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = r[t] = i[t];
            for (; t < 7; t++) e._a[t] = r[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
            24 === e._a[Be] && 0 === e._a[Re] && 0 === e._a[Ue] && 0 === e._a[Ye] && (e._nextDay = !0, e._a[Be] = 0), e._d = (e._useUTC ? yt : bt).apply(null, r), n = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[Be] = 24), e._w && void 0 !== e._w.d && e._w.d !== n && (f(e).weekdayMismatch = !0);
          }
        }
        function Ia(e) {
          ...
          if (e._f !== i.ISO_8601) {
            if (e._f !== i.RFC_2822) {
              ...
              var t,
                ...
                d = u.length,
                c = 0;
              for (l = (n = F(e._f, e._locale).match(C) || []).length, t = 0; t < l; t++) s = n[t], (a = (u.match(Ae(s, e)) || [])[0]) && ((r = u.substr(0, u.indexOf(a))).length > 0 && f(e).unusedInput.push(r), u = u.slice(u.indexOf(a) + a.length), c += a.length), I[s] ? (a ? f(e).empty = !1 : f(e).unusedTokens.push(s), Ne(s, a, e)) : e._strict && !a && f(e).unusedTokens.push(s);
              f(e).charsLeftOver = d - c, u.length > 0 && f(e).unusedInput.push(u), e._a[Be] <= 12 && !0 === f(e).bigHour && e._a[Be] > 0 && (f(e).bigHour = void 0), f(e).parsedDateParts = e._a.slice(0), f(e).meridiem = e._meridiem, e._a[Be] = Ra(e._locale, e._a[Be], e._meridiem), null !== (o = f(e).era) && (e._a[je] = e._locale.erasConvertYear(o, e._a[je])), La(e), ya(e);
            } else Pa(e);
          } else Ta(e);
        }
        function Ra(e, t, a) {
        ...
        function Va(e) {
          ...
          return e._locale = e._locale || va(e._l), null === t || void 0 === a && "" === t ? b({
            nullInput: !0
          }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), S(t) ? new k(ya(t)) : (c(t) ? e._d = t : s(a) ? Ua(e) : a ? Ba(e) : Ga(e), v(e) || (e._d = null), e));
        }
        function Ga(e) {
          var t = e._i;
        ...
        function zi(e, t) {
          return function (a, i) {
            var n;
            return null === i || isNaN(+i) || (T(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), n = a, a = i, i = n), Di(this, Ai(a, i), e), this;
          };
        }
        function Di(e, t, a, n) {
        ...
        function Ri(e, t) {
          1 === arguments.length && (arguments[0] ? Ci(arguments[0]) ? (e = arguments[0], t = void 0) : Ii(arguments[0]) && (t = arguments[0], e = void 0) : (e = void 0, t = void 0));
          var a = e || Za(),
        ...
        function tn(e, t) {
          return this.isValid() && (S(e) && e.isValid() || Za(e).isValid()) ? Ai({
            to: this,
            from: e
        ...
        }), Me("y", be), Me("yy", be), Me("yyy", be), Me("yyyy", be), Me("yo", Un), He(["y", "yy", "yyy", "yyyy"], je), He(["yo"], function (e, t, a, i) {
          var n;
        ...
        }), Fn("gggg", "weekYear"), Fn("ggggg", "weekYear"), Fn("GGGG", "isoWeekYear"), Fn("GGGGG", "isoWeekYear"), Me("G", ye), Me("g", ye), Me("GG", he, le), Me("gg", he, le), Me("GGGG", fe, de), Me("gggg", fe, de), Me("GGGGG", ve, ce), Me("ggggg", ve, ce), Pe(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, a, i) {
          t[i.substr(0, 2)] = ze(e);
        }), Pe(["gg", "GG"], function (e, t, a, n) {
          t[n] = i.parseTwoDigitYear(e);
        }), B("Q", 0, "Qo", "quarter"), Me("Q", oe), He("Q", function (e, t) {
          t[Le] = 3 * (ze(e) - 1);
        }), B("D", ["DD", 2], "Do", "date"), Me("D", he, Ee), Me("DD", he, le), Me("Do", function (e, t) {
          return e ? t._dayOfMonthOrdinalParse || t._ordinalParse : t._dayOfMonthOrdinalParseLenient;
        }), He(["D", "DD"], Ie), He("Do", function (e, t) {
          t[Ie] = ze(e.match(he)[0]);
        });
        var es = Ke("Date", !0);
        function ts(e) {
        ...
        B("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), Me("DDD", ge), Me("DDDD", ue), He(["DDD", "DDDD"], function (e, t, a) {
          a._dayOfYear = ze(e);
        }), B("m", ["mm", 2], 0, "minute"), Me("m", he, $e), Me("mm", he, le), He(["m", "mm"], Re);
        var as = Ke("Minutes", !1);
        B("s", ["ss", 2], 0, "second"), Me("s", he, $e), Me("ss", he, le), He(["s", "ss"], Ue);
        var is,
          ns,
          ss = Ke("Seconds", !1);
        ...
        ps.calendar = P, ps.longDateFormat = G, ps.invalidDate = Z, ps.ordinal = X, ps.preparse = hs, ps.postformat = hs, ps.relativeTime = Q, ps.pastFuture = ee, ps.set = x, ps.eras = On, ps.erasParse = xn, ps.erasConvertYear = zn, ps.erasAbbrRegex = jn, ps.erasNameRegex = Cn, ps.erasNarrowRegex = Ln, ps.months = lt, ps.monthsShort = ut, ps.monthsParse = ct, ps.monthsRegex = ft, ps.monthsShortRegex = gt, ps.week = Et, ps.firstDayOfYear = At, ps.firstDayOfWeek = Mt, ps.weekdays = It, ps.weekdaysMin = Rt, ps.weekdaysShort = Bt, ps.weekdaysParse = Yt, ps.weekdaysRegex = Wt, ps.weekdaysShortRegex = Zt, ps.weekdaysMinRegex = qt, ps.isPM = ta, ps.meridiem = na, ma("en", {
          eras: [{
            since: "0001-01-01",
            until: 1 / 0,
            offset: 1,
        ...
        function Ts() {
          var e,
            ...
            o = this._months,
            l = this._data;
          return s >= 0 && r >= 0 && o >= 0 || s <= 0 && r <= 0 && o <= 0 || (s += 864e5 * As(xs(o) + r), r = 0, o = 0), l.milliseconds = s % 1e3, e = xe(s / 1e3), l.seconds = e % 60, t = xe(e / 60), l.minutes = t % 60, a = xe(t / 60), l.hours = a % 24, r += xe(a / 24), o += n = xe(Os(r)), r -= As(xs(n)), i = xe(o / 12), o %= 12, l.days = r, l.months = o, l.years = i, this;
        }
        function Os(e) {
        ...
        var dr = si.prototype;
        return dr.isValid = ii, dr.abs = Ss, dr.add = $s, dr.subtract = Ms, dr.as = zs, dr.asMilliseconds = Hs, dr.asSeconds = Ps, dr.asMinutes = Ns, dr.asHours = Cs, dr.asDays = js, dr.asWeeks = Ls, dr.asMonths = Is, dr.asQuarters = Bs, dr.asYears = Rs, dr.valueOf = Us, dr._bubble = Ts, dr.clone = Ys, dr.get = Fs, dr.milliseconds = Gs, dr.seconds = Ws, dr.minutes = Zs, dr.hours = qs, dr.days = Ks, dr.weeks = Qs, dr.months = Xs, dr.years = Js, dr.humanize = rr, dr.toISOString = ur, dr.toString = ur, dr.toJSON = ur, dr.locale = rn, dr.localeData = ln, dr.toIsoString = $("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", ur), dr.lang = on, B("X", 0, 0, "unix"), B("x", 0, 0, "valueOf"), Me("x", ye), Me("X", ke), He("X", function (e, t, a) {
          a._d = new Date(1e3 * parseFloat(e));
        }), He("x", function (e, t, a) {
          a._d = new Date(ze(e));
        }),
        //! moment.js
        i.version = "2.30.1", n(Za), i.fn = us, i.min = Ja, i.max = Qa, i.now = ei, i.utc = m, i.unix = ds, i.months = vs, i.isDate = c, i.locale = ma, i.invalid = b, i.duration = Ai, i.isMoment = S, i.weekdays = ys, i.parseZone = cs, i.localeData = va, i.isDuration = ri, i.monthsShort = bs, i.weekdaysMin = ws, i.defineLocale = ga, i.updateLocale = fa, i.locales = ba, i.weekdaysShort = _s, i.normalizeUnits = ae, i.relativeTimeRounding = nr, i.relativeTimeThreshold = sr, i.calendarFormat = Bi, i.prototype = us, i.HTML5_FMT = {
  ...
  let fn = class extends pt(ue) {
    ...
    renderConfig(e, t) {
      ...
      >${s} </label
    `;
      const l = `panels.modules.cards.module.config-descriptions.${a.name}.${n}`,
        u = `panels.modules.cards.module.config-descriptions.${n}`;
      let d = Zi(l, this.hass.language);
      d === l && (d = Zi(u, this.hass.language));
      const c = d !== u && d !== l;
      ...
      return i.required && (o = Y`${o} *`), o = Y`<div class="schemaline">
      ${o}
      ${c ? Y`<div class="config-description">${d}</div>` : ""}
    </div>`, o;
    }
    ...
    render() {
      ...
      <div class="header">
        <div class="toolbar">
          ...
          <div class="version">${"v2025.6.0-beta5"}</div>
        </div>
